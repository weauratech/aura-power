...
const authenticatedProjects = expandedBrowsers
  ? [
      ...
      { name: 'mobile-firefox', use: { ...devices['Desktop Firefox'], viewport: { width: 393, height: 873 }, hasTouch: true } },
...
export default defineConfig({
  ...
  projects: [
    ...
    ...unauthenticatedProjects.map((project) => ({ ...project, testMatch: /auth\.spec\.ts/ })),
